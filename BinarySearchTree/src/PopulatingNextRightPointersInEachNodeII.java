...
public class PopulatingNextRightPointersInEachNodeII {
	...
	// TC - O(n)   SC - O(1)
	public TreeNode4 connect(TreeNode4 root) {
        if(root == null)
        {
            return root;
        }
        ...
        TreeNode4 childHead = null;
        TreeNode4 prev = null;
        
        //this loop is for different levels
        while(current != null)
        {
            //this iterates over same level
            while(current != null)
            {
                //left child
...
//		TreeNode4 result1 = p.connectWithBreadthFirstSearch(root);
		TreeNode4 result2 = p.connect(root);
